...
RSpec.describe OrderAddress, type: :model do
  describe '#create' do
    ...
    it '電話番号情報が存在すれば登録できること' do
      @order.phone_number = nil
      @order.valid?
      expect(@order.errors.full_messages).to include("Phone number can't be blank")
    end
    it '電話番号情報に"-"が存在しなければ登録できること' do
